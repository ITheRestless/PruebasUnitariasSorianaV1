...
namespace Cliente.Modelos
{
    public partial class Cliente1
    {
        ...
        public Cliente1(string nombre, string email, string password)
        {
            Nombre = nombre;
            Mail = email;
            Password = password;
        ...
        public Cliente1(string nombre, string email, string password, string apellidoPat, string apellidoMat)
        {
            Nombre = nombre;
            Mail = email;
            Password = password;
        ...
        public static Cliente1 FromJson(string json) => JsonConvert.DeserializeObject<Cliente1>(json, Converter.Settings);
