...
namespace Estracto_Por_Categoria_Padre
{
    ...
    public class EstractoPorCategoriaPadre_Test
    {
        ...
        static Cliente clienteTester = new Cliente("Iván " + NombreTester, "testersubcategoria" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
        static ClienteAlterno clienteTester2 = new ClienteAlterno("Iván " + NombreTester, "testersubcategoria" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
