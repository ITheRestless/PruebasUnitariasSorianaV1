...
namespace Estracto_Promociones
{
    ...
    public class EstractoPromociones_Test
    {
        ...
        static Cliente clienteTester = new Cliente("Iván " + NombreTester, "testerpromociones" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
        static ClienteAlterno clienteTester2 = new ClienteAlterno("Iván " + NombreTester, "testerpromociones" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
