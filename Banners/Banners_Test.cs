...
namespace Banners
{
    ...
    public class Banners_Test
    {
        ...
        static Cliente clienteTester = new Cliente("Iván " + NombreTester, "testerbanners" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
        static ClienteAlterno clienteTester2 = new ClienteAlterno("Iván " + NombreTester, "testerbanners" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
