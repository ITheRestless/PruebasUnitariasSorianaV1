...
namespace Promociones
{
    ...
    public class Promociones_Test
    {
        ...
        static Cliente clienteTester = new Cliente("Iván " + NombreTester, "testerpromos" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
        static ClienteAlterno clienteTester2 = new ClienteAlterno("Iván " + NombreTester, "testerpromos" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
