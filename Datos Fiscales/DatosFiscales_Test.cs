...
namespace Datos_Fiscales
{
    ...
    public class DatosFiscales_Test
    {
        ...
        static Cliente clienteTester = new Cliente("Iván " + NombreTester, "testerdatosfiscales" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
        static ClienteAlterno clienteTester2 = new ClienteAlterno("Iván " + NombreTester, "testerdatosfiscales" + NombreTester + "@unittest.com", "123456", "Rodríguez", "Quiroz");
